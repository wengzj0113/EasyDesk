...
const SettingsPage: React.FC = () => {
  ...
  const [settings, setSettings] = useState({
    videoQuality: '720p' as string,
    frameRate: 30 as number,
    audioEnabled: true as boolean,
    notificationEnabled: true as boolean,
    autoConnect: false as boolean,
    savePassword: false as boolean,
  });
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          ...
          <div style={{ marginTop: '16px' }}>
            ...
            <Slider
              ...
              onChange={(value) => setSettings({ ...settings, frameRate: value })}
            />
          </div>
        </Space>
      ),
      ...
      content: (
        <Space>
          ...
          <Switch
            ...
            onChange={(checked) => setSettings({ ...settings, audioEnabled: checked })}
          />
        </Space>
      ),
    },
      ...
      content: (
        <Space>
          ...
          <Switch
            ...
            onChange={(checked) => setSettings({ ...settings, notificationEnabled: checked })}
          />
        </Space>
      ),
    },
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          <Space>
            ...
            <Switch
              ...
              onChange={(checked) => setSettings({ ...settings, autoConnect: checked })}
            />
          </Space>
          <div style={{ marginTop: '8px' }}>
            <Space>
              ...
              <Switch
                ...
                onChange={(checked) => setSettings({ ...settings, savePassword: checked })}
              />
            </Space>
          </div>
        </Space>
  ...
  return (
    <div style={{ padding: '50px', maxWidth: 800, margin: '0 auto' }}>
      ...
      {/* 用户信息 */}
      <Card style={{ marginBottom: '24px' }} title={<><UserOutlined /> 账户信息</>}>
        {user ? (
          <Space direction="vertical" style={{ width: '100%' }}>
            <div>
          ...
          <div>
            ...
            <Button type="primary" style={{ marginLeft: '16px' }} onClick={() => navigate('/')}>
              登录
            </Button>
          </div>
        )}
      ...
      <Card style={{ marginTop: '24px' }} title={<><InfoCircleOutlined /> 关于</>}>
